...
exports.getHint = function(id,level){
    var hint = dataStore.db.collection('hints').findOne({_id:{$eq:id}},{l1:level==1?1:0, l2:level==1?1:0});
    var text = '';
    if (hint) {
...
exports.getHintTitles = async function(){
    //var cursor = dataStore.db.collection('hints').find({},{title:1, l1:0, l2:0});
