...
exports.log2db = function(pin,pinId,eventType,msg){
    dataStore.db.collection('log').insertOne({date:new Date(),pin:pin, pinId:pinId, event:eventType, message:msg}, function(err, r) {
...
exports.getActivePINs = function(callback){
    ...
    dataStore.db.collection('pins').find({$or:[ {expired:null}, {expired:{$gt:new Date()}}]}).toArray(callback);
};
...
exports.checkPIN = function(enteredPin, callback){
    ...
    dataStore.db.collection('pins').findOneAndUpdate(q, u, {returnOriginal:false}, callback);
    console.log('checkPin done');
};

exports.getSettings = function(callback){
    console.log('getSettings');
    dataStore.db.collection('settings').findOne({}, callback);
